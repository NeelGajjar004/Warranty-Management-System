...
{!! Form::model($vendors, ['method' => 'PATCH','enctype' => 'multipart/form-data','route' => ['vencomstore', $vendors->vendor_id]]) !!}
<div class="row">
    <div class="col-xs-6 col-sm-6 col-md-6 mb-2">
        <div class="form-group">
            <strong>Vendors : </strong>
            <input type="text" name="vendor_id" id="vendor_id" value="{{$vendors->id}}">
